...
def main(args):
    ...
    for i, sample in enumerate(progress_bar):
        ...
        for _ in range(args.max_len-1):
            ...
            # see __QUESTION 2 
            # insert squared regularizer
            log_prob_t = torch.log(torch.softmax(decoder_out, dim=2))
            log_probs, next_candidates = torch.topk((log_prob_t - 0.5*log_prob_t**2), args.beam_size+1, dim=-1)
